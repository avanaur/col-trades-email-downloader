package com.tyronevillaluna.cted;
...
public class GmailDownloader {
	...
	/** Trading confirmation directory */
	private static final java.io.File TRADING_CONFIRMATION = new java.io.File(System.getProperty("user.home"),
			"tradingconfirmations");

	/** Trading confirmation directory */
	private static final java.io.File LAST_PROCESSED = new java.io.File(System.getProperty("user.home"),
			".gmail-downloader-last-processed.ser");
